        ...
        <div class="row">
            ...
            <div class="col-sm-3">
             ...
             <div class="col-10 ">
                ...
                <textarea type="text" cols="10" rows="6" name="reason" class="form-control @error('reason') is-invalid @enderror" value="{{ $offering->reason}}"  autocomplete="reason" autofocus  id="email" > </textarea>
